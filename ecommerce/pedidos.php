    ...
    <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasMenu" aria-labelledby="offcanvasMenuLabel">
        ...
        <div class="offcanvas-body">
            ...
            <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item"><a href="logout.php" class="text-decoration-none text-dark">Cerrar Sesión</a></li>
            </ul>
        </div>
    </div>
                            ...
                            <div class="order-card">
                                <div class="order-header">
                                    <div>
                                        ...
                                        <span>Fecha: <?php echo htmlspecialchars(date('d/m/Y H:i', strtotime($order['info']['fecha_compra']))); ?></span><br>
                                        <span>Estado: <?php echo htmlspecialchars($order['info']['estado_compra']); ?></span><br>
                                        <span>Almacén: <?php echo htmlspecialchars($order['info']['nombre_almacen']); ?></span>
                                    </div>
                                    <div class="text-end">
                                        Total del Pedido: <span class="text-success">S/ <?php echo number_format($order['total'], 2); ?></span>
                                    </div>
                                </div>
                                <div class="order-body">
                                    <?php foreach ($order['details'] as $detail): ?>
                                        <div class="order-details-item">
                                            <img src="<?php echo htmlspecialchars($detail['ruta_imagen']); ?>" alt="<?php echo htmlspecialchars($detail['producto_nombre']); ?>" onerror="this.onerror=null;this.src='https://placehold.co/80x80/F0F0F0/333?text=No+Img';">
                                            <div class="order-item-info">
                                                <h6><?php echo htmlspecialchars($detail['producto_nombre']); ?></h6>
                                                <p>Cantidad: <?php echo htmlspecialchars($detail['cantidad']); ?></p>
                                                <p>Precio Unitario: S/ <?php echo number_format($detail['precio_unitario'], 2); ?></p>
                                                <?php if ($detail['descuento'] > 0): ?>
                                                    <p class="text-danger">Descuento: S/ <?php echo number_format($detail['descuento'], 2); ?></p>
                                                <?php endif; ?>
                                                <p>Subtotal: S/ <?php echo number_format($detail['cantidad'] * $detail['precio_unitario'] - $detail['descuento'], 2); ?></p>
                                            </div>
                                        </div>
                                    <?php endforeach; ?>
                                </div>
